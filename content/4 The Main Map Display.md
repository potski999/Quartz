...
Pressing the hotkey [0] toggles on the Strategic Map which replaces the Main Map Display screen. **The Strategic Map provides a zoomed** - out overview of the progress of the war. See the Main Map Display below:
...
> Content in this section was sourced from page(s) **52** of the [[War in Spain manual EBOOK.pdf|original PDF EBOOK]].
